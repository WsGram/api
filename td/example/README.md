...
If you are looking for documentation of all available TDLib methods, see the [td_api.tl](https://github.com/wsgram/wsgram/blob/master/td/generate/scheme/td_api.tl) scheme or the
...
You can also check out [example/python/tdjson_example.py](https://github.com/wsgram/wsgram/blob/master/example/python/tdjson_example.py),
...
TDLib can be compiled to WebAssembly or asm.js and used in a browser from JavaScript. See [tdweb](https://github.com/wsgram/wsgram/tree/master/example/web) as a convenient wrapper for TDLib in a browser
...
See [example/java](https://github.com/wsgram/wsgram/tree/master/example/java) for an example of using TDLib from desktop Java along with detailed building and usage instructions.
...
See [example/uwp](https://github.com/wsgram/wsgram/tree/master/example/uwp) for an example of building TDLib SDK for the Universal Windows Platform and an example of its usage from C#.
See [example/csharp](https://github.com/wsgram/wsgram/tree/master/example/csharp) for an example of building TDLib with `C++/CLI` support and an example of TDLib usage from C# on Windows.
...
See [example/cpp](https://github.com/wsgram/wsgram/tree/master/example/cpp) for an example of TDLib usage from C++.
[td_example.cpp](https://github.com/wsgram/wsgram/blob/master/example/cpp/td_example.cpp) contains an example of authorization, processing new incoming messages, getting a list of chats and sending a text message.
...
See [example/ios](https://github.com/wsgram/wsgram/tree/master/example/ios) for an example of building TDLib for iOS, watchOS, tvOS, and macOS.
...
See [example/swift](https://github.com/wsgram/wsgram/tree/master/example/swift) for an example of a macOS Swift application.
...
You can also try to use our [C](https://github.com/wsgram/wsgram/blob/master/td/telegram/td_c_client.h) client, which was used by the private TDLib-based version of [telegram-cli](https://github.com/vysheng/tg).
