...
For example of usage take a look at our [Swift example](https://github.com/wsgram/wsgram/tree/master/example/swift).
...
We use [CMake/iOS.cmake](https://github.com/wsgram/wsgram/blob/master/CMake/iOS.cmake) toolchain, other toolchains may work too.
