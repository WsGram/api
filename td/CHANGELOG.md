...
* Changes in [tdweb](https://github.com/wsgram/wsgram/blob/master/example/web/):
...
* Added an example of TDLib building and usage from a browser.
  See https://github.com/wsgram/wsgram/blob/master/example/web/ for more details.
...
* Added a review of existing TDLib based [frameworks](https://github.com/wsgram/wsgram/blob/master/example/README.md)
